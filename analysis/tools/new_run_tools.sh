...
rnasamba classify test_rnasamba_mammalian.tsv data/mammalian_1k_test_nonredundant_80.csv rnasamba.hdf5

# run CPC2,  must use python2
#cd ../tools/CPC2-beta
#export CPC_HOME="$PWD"
python bin/CPC2.py - data/ -o test_cpc2_mammalian.txt
...
# run on our test set
cpat.py -x mammalian_Hexamer.tsv -d Mammals.logit.RData -g ../Fa/test_RNA.fa --top-orf=5 -o test_cpat_mammalian
