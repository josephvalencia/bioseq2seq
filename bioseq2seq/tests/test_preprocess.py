...
import bioseq2seq.bin.preprocess as preprocess


parser = configargparse.ArgumentParser(description='preprocess.py')
bioseq2seq.opts.preprocess_opts(parser)
...
class TestData(unittest.TestCase):
    ...
    def dataset_build(self, opt):
        fields = bioseq2seq.inputters.get_fields("text", 0, 0)
        ...
        src_reader = bioseq2seq.inputters.str2reader[opt.data_type].from_opt(opt)
        tgt_reader = bioseq2seq.inputters.str2reader["text"].from_opt(opt)
        align_reader = bioseq2seq.inputters.str2reader["text"].from_opt(opt)
