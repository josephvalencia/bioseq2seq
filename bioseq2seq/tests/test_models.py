...
from bioseq2seq.model_builder import build_embeddings, \
...
bioseq2seq.opts.model_opts(parser)
bioseq2seq.opts.train_opts(parser)
...
class TestModel(unittest.TestCase):
    ...
    def get_field(self):
        src = bioseq2seq.inputters.get_fields("text", 0, 0)["src"]
    ...
    def nmtmodel_forward(self, opt, source_l=3, bsize=1):
        ...
        model = bioseq2seq.models.model.NMTModel(enc, dec)
...
if bioseq2seq.models.sru.check_sru_requirement():
