...
class RNNDecoderBase(DecoderBase):
    ...
    and required by :class:`~bioseq2seq.models.NMTModel`.
    ...
    Args:
       ...
       attn_type (str) : see :class:`~bioseq2seq.modules.GlobalAttention`
       attn_func (str) : see :class:`~bioseq2seq.modules.GlobalAttention`
       coverage_attn (str): see :class:`~bioseq2seq.modules.GlobalAttention`
       context_gate (str): see :class:`~bioseq2seq.modules.ContextGate`
       ...
       copy_attn_type (str): The copy attention style. See
        :class:`~bioseq2seq.modules.GlobalAttention`.
    """
...
class StdRNNDecoder(RNNDecoderBase):
    ...
    See :class:`~bioseq2seq.decoders.decoder.RNNDecoderBase` for options.
