...
class Dataset(TorchtextDataset):
    ...
    Args:
        fields (dict[str, Field]): a dict with the structure
            returned by :func:`bioseq2seq.inputters.get_fields()`. Usually
            ...
            :class:`bioseq2seq.inputters.TextMultiField`.)
        readers (Iterable[bioseq2seq.inputters.DataReaderBase]): Reader objects
        ...
        for ex_dict in starmap(_join_dicts, zip(*read_iters)):
            if can_copy:
                ...
                src_ex_vocab, ex_dict = _dynamic_dict(
                    ex_dict, src_field.base_field, tgt_field.base_field, id_field.base_field)
