...
def run(opt, device_id, error_queue, batch_queue, semaphore):
    """ run process """
    try:
        gpu_rank = bioseq2seq.utils.distributed.multi_init(opt, device_id)
