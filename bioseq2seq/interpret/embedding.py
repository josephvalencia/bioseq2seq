...
class GradientAttribution(EmbeddingAttribution):
    ...
    def __init__(self,model,device,vocab,method,tgt_class,softmax=True,sample_size=None,batch_size=None,times_input=False,smoothgrad=False):
        
        super().__init__(model,device,vocab,method,tgt_class,softmax=True,sample_size=None,batch_size=None)
