...
from torchtext.data import batch as torchtext_batch, Dataset as TorchtextDataset
from bioseq2seq.constants import DefaultTokens
import bioseq2seq.inputters as inputters
from bioseq2seq.inputters.text_dataset import InferenceDataIterator
from bioseq2seq.inputters.corpus import get_corpora, build_corpora_iters,DatasetAdapter
from bioseq2seq.translate.beam_search import BeamSearch, BeamSearchLM
from bioseq2seq.translate.greedy_search import GreedySearch, GreedySearchLM
from bioseq2seq.translate.translation import TranslationBuilder
...
def test_effective_batch_size(iterator):
...
def plot_frequency_heatmap(tscript_name,mod_freq):
...
class Inference(object):
    ...
    def from_opt(
        ...
        Args:
            model (bioseq2seq.modules.NMTModel): See :func:`__init__()`.
    ...
    def _bucketing(self,dataset,bucket_size):
...
class Translator(Inference):
    ...
    def _run_encoder(self, batch):
        ...
        enc_states, memory_bank, src_lengths, enc_cache  = self.model.encoder(
            src, src_lengths
        )
