...
from bioseq2seq.encoders import str2enc

from bioseq2seq.decoders import str2dec

from bioseq2seq.modules import Embeddings, VecEmbedding, CopyGenerator
from bioseq2seq.modules.util_class import Cast
...
def build_base_model(model_opt, fields, gpu, checkpoint=None, gpu_id=None):
    ...
    Args:
        model_opt: the option loaded from checkpoint. It's important that
            ...
            :class:`bioseq2seq.utils.parse.ArgumentParser`.
    ...
    model = bioseq2seq.models.NMTModel(encoder, decoder)

    # Build Generator.
    if not model_opt.copy_attn:
        if model_opt.generator_function == "sparsemax":
            gen_func = bioseq2seq.modules.sparse_activations.LogSparsemax(dim=-1)
        else:
