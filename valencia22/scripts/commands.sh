...
export CHKPT_DIR="$BIOHOME/bioseq2seq/valencia22/checkpoints/coding_noncoding/"
...
export PRED_TEST_BIO_CLASS="python $PYTHONPATH/bioseq2seq/bin/translate_new.py --input $test_set --mode bioseq2seq  --num_gpus 1 --beam_size 4 --n_best 4 --max_decode_len 1 --max_tokens 1200" 

export PRED_TEST_EDC="python $PYTHONPATH/bioseq2seq/bin/translate_new.py --input $test_set --mode EDC --num_gpus 1 --beam_size 4 --n_best --max_tokens 1200" 

export EG_VAL_EDC="python $PYTHONPATH/bioseq2seq/bin/run_attribution.py --input $val_set --inference_mode EDC --num_gpus 1 --attribution_mode EG --max_tokens 300" 
export EG_TEST_EDC="python $PYTHONPATH/bioseq2seq/bin/run_attribution.py --input $test_set --inference_mode EDC --num_gpus 1 --attribution_mode EG --max_tokens 300" 
export EG_VAL_BIO="python $PYTHONPATH/bioseq2seq/bin/run_attribution.py --input $val_set --inference_mode bioseq2seq --num_gpus 1 --attribution_mode EG --max_tokens 300" 
export EG_TEST_BIO="python $PYTHONPATH/bioseq2seq/bin/run_attribution.py --input $test_set --inference_mode bioseq2seq --num_gpus 1 --attribution_mode EG --max_tokens 300" 
