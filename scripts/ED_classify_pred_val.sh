...
python $BIOHOME/bioseq2seq/bioseq2seq/bin/translate.py --input $BIOHOME/Fa/val.csv --checkpoint $BIOHOME/bioseq2seq/checkpoints/coding_noncoding/Oct06_18-51-35/_step_150000.pt --output_name ED_classify_1_val  --mode ED_classify --dataset val --rank 0
