...
#python $BIOHOME/bioseq2seq/bioseq2seq/bin/translate.py --input data/mammalian_200-1200/mammalian_200-1200_val_nonredundant_80.csv --checkpoint $BIOHOME/bioseq2seq/checkpoints/coding_noncoding/Jan30_16-32-20/_step_2500.pt --output_name seq2seq_val --mode bioseq2seq --rank 0 --num_gpus 4 --beam_size 2 
python $BIOHOME/bioseq2seq/bioseq2seq/bin/translate.py --input data/mammalian_200-1200/mammalian_200-1200_val_nonredundant_80.csv --checkpoint $BIOHOME/bioseq2seq/checkpoints/coding_noncoding/Feb06_21-11-26/_step_2000.pt --output_name seq2seq_val --mode bioseq2seq --rank 0 --num_gpus 4 --beam_size 2 
#python $BIOHOME/bioseq2seq/bioseq2seq/bin/translate.py --input data/mammalian_200-1200/mammalian_200-1200_val_nonredundant_80.csv --checkpoint $BIOHOME/bioseq2seq/checkpoints/coding_noncoding/Feb14_14-41-48/_step_13000.pt --output_name seq2seq_val --mode bioseq2seq --rank 0 --num_gpus 4 --beam_size 2 
#python $BIOHOME/bioseq2seq/bioseq2seq/bin/translate.py --input data/mammalian_200-1200/mammalian_200-1200_val_nonredundant_80.csv --checkpoint $BIOHOME/bioseq2seq/checkpoints/coding_noncoding/Feb02_19-59-50/_step_5000.pt --output_name seq2seq_val --mode ED_classify --rank 0 --num_gpus 4 --beam_size 4 
