...
python $BIOHOME/bioseq2seq/bioseq2seq/bin/translate.py --input data/mammalian_200-1200/mammalian_200-1200_val_nonredundant_80.csv --checkpoint $BIOHOME/bioseq2seq/checkpoints/coding_noncoding/Mar15_14-40-27/_step_2.pt --output_name seq2seq_val --mode bioseq2seq --rank 0 --num_gpus 0 --beam_size 2 
