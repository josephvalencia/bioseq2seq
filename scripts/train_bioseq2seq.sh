...
python $BIOHOME/bioseq2seq/bin/train.py --train data/mammalian_200-1200/mammalian_200-1200_train_balanced.csv --val data/mammalian_200-1200/mammalian_200-1200_val_nonredundant_80.csv --num_gpus 1 --mode ED_classify --save-directory $BIOHOME/checkpoints/coding_noncoding/ --accum_steps 8 --max_tokens 9000 --n_enc_layers 6 --n_dec_layers 6 --model_dim 32 --max_rel_pos 8 --report-every 500 --max-epochs 100000 --patience 10 --lr 1.0
