...
BIO_dir="${BIOHOME}/bioseq2seq/experiments/output/bioseq2seq_CNN_3_Jul02_19-50-23_step_11000/"
...
echo $rna
python $PYTHONPATH/bioseq2seq/interpret/run_attribution.py --input $rna --tgt_input $prot --mode bioseq2seq --num_gpus 1 --attribution_mode logit --max_tokens 300 --checkpoint ${CHKPT_DIR}bioseq2seq_CNN_3_Jul02_19-50-23/_step_11000.pt --name $BIO_dir --tgt_class PC --tgt_pos 1 --rank 0 --minibatch_size 8
